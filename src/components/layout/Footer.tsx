  ...
  return (
    <footer className="bg-[#0a0a0a] border-t border-[#D4AF37]/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-10 sm:py-16 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-8">
          {/* Brand */}
          <ScrollReveal className="col-span-2 sm:col-span-1">
        ...
        {/* Bottom bar */}
        <div className="py-4 sm:py-6 border-t border-[#D4AF37]/10 flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-3">
